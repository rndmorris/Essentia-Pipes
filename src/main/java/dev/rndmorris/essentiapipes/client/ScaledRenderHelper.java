...
public class ScaledRenderHelper {
    ...
    public static boolean renderStandardBlock(RenderBlocks renderer, Block blockType, int blockX, int blockY,
        ...
        return Minecraft.isAmbientOcclusionEnabled() && blockType.getLightValue() == 0
            ? (renderer.partialRenderBounds
                ? renderStandardBlockWithAmbientOcclusionPartial(renderer, blockType, blockX, blockY, blockZ, f, f1, f2)
                : renderStandardBlockWithAmbientOcclusion(renderer, blockType, blockX, blockY, blockZ, f, f1, f2))
            : renderStandardBlockWithColorMultiplier(renderer, blockType, blockX, blockY, blockZ, f, f1, f2);
    }

    public static boolean renderStandardBlockWithAmbientOcclusion(RenderBlocks renderer, Block p_147751_1_,
        int p_147751_2_, int p_147751_3_, int p_147751_4_, float p_147751_5_, float p_147751_6_, float p_147751_7_) {
        ...
        if (renderer.getBlockIcon(p_147751_1_)
            .getIconName()
            .equals("grass_top")) {
            flag1 = false;
        ...
        if (renderer.renderAllFaces
            || p_147751_1_.shouldSideBeRendered(renderer.blockAccess, p_147751_2_, p_147751_3_ - 1, p_147751_4_, 0)) {
            if (renderer.renderMinY <= 0.0D) {
                --p_147751_3_;
            }

            renderer.aoBrightnessXYNN = p_147751_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_ - 1, p_147751_3_, p_147751_4_);
            renderer.aoBrightnessYZNN = p_147751_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_ - 1);
            renderer.aoBrightnessYZNP = p_147751_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_ + 1);
            renderer.aoBrightnessXYPN = p_147751_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_ + 1, p_147751_3_, p_147751_4_);
            renderer.aoLightValueScratchXYNN = renderer.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZNN = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_ - 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZNP = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_ + 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXYPN = renderer.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_)
                .getAmbientOcclusionLightValue();
            flag2 = renderer.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_ - 1, p_147751_4_)
                .getCanBlockGrass();
            flag3 = renderer.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_ - 1, p_147751_4_)
                .getCanBlockGrass();
            flag4 = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_ + 1)
                .getCanBlockGrass();
            flag5 = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_ - 1)
                .getCanBlockGrass();
            ...
            if (!flag5 && !flag3) {
                ...
                renderer.aoLightValueScratchXYZNNN = renderer.blockAccess
                    ...
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNNN = p_147751_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_ - 1, p_147751_3_, p_147751_4_ - 1);
            }
            ...
            if (!flag4 && !flag3) {
                ...
                renderer.aoLightValueScratchXYZNNP = renderer.blockAccess
                    .getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_ + 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNNP = p_147751_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_ - 1, p_147751_3_, p_147751_4_ + 1);
            }
            ...
            if (!flag5 && !flag2) {
                ...
                renderer.aoLightValueScratchXYZPNN = renderer.blockAccess
                    .getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_ - 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZPNN = p_147751_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_ + 1, p_147751_3_, p_147751_4_ - 1);
            }
            ...
            if (!flag4 && !flag2) {
                ...
                renderer.aoLightValueScratchXYZPNP = renderer.blockAccess
                    .getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_ + 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZPNP = p_147751_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_ + 1, p_147751_3_, p_147751_4_ + 1);
            }
            ...
            if (renderer.renderMinY <= 0.0D || !renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_)
                .isOpaqueCube()) {
                i1 = p_147751_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_, p_147751_3_ - 1, p_147751_4_);
            }

            f7 = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_)
                .getAmbientOcclusionLightValue();
            ...
            renderFaceYNeg(
                ...
                (double) p_147751_3_,
                (double) p_147751_4_,
                renderer.getBlockIcon(p_147751_1_, renderer.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_, 0));
            flag = true;
        }

        if (renderer.renderAllFaces
            || p_147751_1_.shouldSideBeRendered(renderer.blockAccess, p_147751_2_, p_147751_3_ + 1, p_147751_4_, 1)) {
            if (renderer.renderMaxY >= 1.0D) {
                ++p_147751_3_;
            }

            renderer.aoBrightnessXYNP = p_147751_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_ - 1, p_147751_3_, p_147751_4_);
            renderer.aoBrightnessXYPP = p_147751_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_ + 1, p_147751_3_, p_147751_4_);
            renderer.aoBrightnessYZPN = p_147751_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_ - 1);
            renderer.aoBrightnessYZPP = p_147751_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_ + 1);
            renderer.aoLightValueScratchXYNP = renderer.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXYPP = renderer.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZPN = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_ - 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZPP = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_ + 1)
                .getAmbientOcclusionLightValue();
            flag2 = renderer.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_ + 1, p_147751_4_)
                .getCanBlockGrass();
            flag3 = renderer.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_ + 1, p_147751_4_)
            ...
            if (!flag5 && !flag3) {
                ...
                renderer.aoLightValueScratchXYZNPN = renderer.blockAccess
                    .getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_ - 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNPN = p_147751_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_ - 1, p_147751_3_, p_147751_4_ - 1);
            }
            ...
            if (!flag5 && !flag2) {
                ...
                renderer.aoLightValueScratchXYZPPN = renderer.blockAccess
                    .getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_ - 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZPPN = p_147751_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_ + 1, p_147751_3_, p_147751_4_ - 1);
            }
            ...
            if (!flag4 && !flag3) {
                ...
                renderer.aoLightValueScratchXYZNPP = renderer.blockAccess
                    .getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_ + 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNPP = p_147751_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_ - 1, p_147751_3_, p_147751_4_ + 1);
            }
            ...
            if (!flag4 && !flag2) {
                ...
                renderer.aoLightValueScratchXYZPPP = renderer.blockAccess
                    .getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_ + 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZPPP = p_147751_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_ + 1, p_147751_3_, p_147751_4_ + 1);
            }
            ...
            if (renderer.renderMaxY >= 1.0D || !renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_)
                .isOpaqueCube()) {
                i1 = p_147751_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_, p_147751_3_ + 1, p_147751_4_);
            }
            ...
            renderFaceYPos(
                ...
                (double) p_147751_3_,
                (double) p_147751_4_,
                renderer.getBlockIcon(p_147751_1_, renderer.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_, 1));
            flag = true;
        }
        ...
        if (renderer.renderAllFaces
            || p_147751_1_.shouldSideBeRendered(renderer.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_ - 1, 2)) {
            if (renderer.renderMinZ <= 0.0D) {
                --p_147751_4_;
            }

            renderer.aoLightValueScratchXZNN = renderer.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZNN = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZPN = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXZPN = renderer.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoBrightnessXZNN = p_147751_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_ - 1, p_147751_3_, p_147751_4_);
            renderer.aoBrightnessYZNN = p_147751_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_, p_147751_3_ - 1, p_147751_4_);
            renderer.aoBrightnessYZPN = p_147751_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_, p_147751_3_ + 1, p_147751_4_);
            renderer.aoBrightnessXZPN = p_147751_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_ + 1, p_147751_3_, p_147751_4_);
            flag2 = renderer.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_ - 1)
                .getCanBlockGrass();
            flag3 = renderer.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_ - 1)
                .getCanBlockGrass();
            flag4 = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_ - 1)
                .getCanBlockGrass();
            flag5 = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_ - 1)
            ...
            if (!flag3 && !flag5) {
                ...
                renderer.aoLightValueScratchXYZNNN = renderer.blockAccess
                    ...
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNNN = p_147751_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_ - 1, p_147751_3_ - 1, p_147751_4_);
            }
            ...
            if (renderer.renderMinZ <= 0.0D || !renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_ - 1)
                .isOpaqueCube()) {
                i1 = p_147751_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_ - 1);
            }

            f7 = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_ - 1)
                .getAmbientOcclusionLightValue();
        ...
        if (renderer.renderAllFaces
            || p_147751_1_.shouldSideBeRendered(renderer.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_ + 1, 3)) {
            if (renderer.renderMaxZ >= 1.0D) {
                ++p_147751_4_;
            }

            renderer.aoLightValueScratchXZNP = renderer.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXZPP = renderer.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZNP = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZPP = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoBrightnessXZNP = p_147751_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_ - 1, p_147751_3_, p_147751_4_);
            renderer.aoBrightnessXZPP = p_147751_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_ + 1, p_147751_3_, p_147751_4_);
            renderer.aoBrightnessYZNP = p_147751_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_, p_147751_3_ - 1, p_147751_4_);
            renderer.aoBrightnessYZPP = p_147751_1_
            ...
            if (renderer.renderMaxZ >= 1.0D || !renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_ + 1)
                .isOpaqueCube()) {
                i1 = p_147751_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_ + 1);
            }
            ...
            renderFaceZPos(
                ...
                (double) p_147751_3_,
                (double) p_147751_4_,
                renderer.getBlockIcon(p_147751_1_, renderer.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_, 3));
        ...
        if (renderer.renderAllFaces
            || p_147751_1_.shouldSideBeRendered(renderer.blockAccess, p_147751_2_ - 1, p_147751_3_, p_147751_4_, 4)) {
            if (renderer.renderMinX <= 0.0D) {
                --p_147751_2_;
            }

            renderer.aoLightValueScratchXYNN = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXZNN = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_ - 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXZNP = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_ + 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXYNP = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoBrightnessXYNN = p_147751_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_, p_147751_3_ - 1, p_147751_4_);
            renderer.aoBrightnessXZNN = p_147751_1_
            ...
            flag3 = renderer.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_ - 1, p_147751_4_)
                .getCanBlockGrass();
            flag4 = renderer.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_ - 1)
                .getCanBlockGrass();
            flag5 = renderer.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_ + 1)
                .getCanBlockGrass();
            ...
            if (!flag4 && !flag3) {
                ...
                renderer.aoLightValueScratchXYZNNN = renderer.blockAccess
                    ...
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNNN = p_147751_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_, p_147751_3_ - 1, p_147751_4_ - 1);
            }
            ...
            if (renderer.renderMinX <= 0.0D || !renderer.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_)
                .isOpaqueCube()) {
                i1 = p_147751_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_ - 1, p_147751_3_, p_147751_4_);
            }

            f7 = renderer.blockAccess.getBlock(p_147751_2_ - 1, p_147751_3_, p_147751_4_)
                .getAmbientOcclusionLightValue();
        ...
        if (renderer.renderAllFaces
            || p_147751_1_.shouldSideBeRendered(renderer.blockAccess, p_147751_2_ + 1, p_147751_3_, p_147751_4_, 5)) {
            if (renderer.renderMaxX >= 1.0D) {
                ++p_147751_2_;
            }

            renderer.aoLightValueScratchXYPN = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_ - 1, p_147751_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXZPN = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_ - 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXZPP = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_ + 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXYPP = renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_ + 1, p_147751_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoBrightnessXYPN = p_147751_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_, p_147751_3_ - 1, p_147751_4_);
            renderer.aoBrightnessXZPN = p_147751_1_
            ...
            if (renderer.renderMaxX >= 1.0D || !renderer.blockAccess.getBlock(p_147751_2_ + 1, p_147751_3_, p_147751_4_)
                .isOpaqueCube()) {
                i1 = p_147751_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147751_2_ + 1, p_147751_3_, p_147751_4_);
            }
     ...
     */
    public static boolean renderStandardBlockWithAmbientOcclusionPartial(RenderBlocks renderer, Block p_147808_1_,
        int p_147808_2_, int p_147808_3_, int p_147808_4_, float p_147808_5_, float p_147808_6_, float p_147808_7_) {
        renderer.enableAO = true;
        boolean flag = false;
        float f3 = 0.0F;
        float f4 = 0.0F;
        ...
        if (renderer.getBlockIcon(p_147808_1_)
            .getIconName()
            .equals("grass_top")) {
            flag1 = false;
        } else if (renderer.hasOverrideBlockTexture()) {
        ...
        if (renderer.renderAllFaces
            || p_147808_1_.shouldSideBeRendered(renderer.blockAccess, p_147808_2_, p_147808_3_ - 1, p_147808_4_, 0)) {
            if (renderer.renderMinY <= 0.0D) {
                --p_147808_3_;
            }

            renderer.aoBrightnessXYNN = p_147808_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_ - 1, p_147808_3_, p_147808_4_);
            renderer.aoBrightnessYZNN = p_147808_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_ - 1);
            renderer.aoBrightnessYZNP = p_147808_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_ + 1);
            renderer.aoBrightnessXYPN = p_147808_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_ + 1, p_147808_3_, p_147808_4_);
            renderer.aoLightValueScratchXYNN = renderer.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZNN = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_ - 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZNP = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_ + 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXYPN = renderer.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_)
                .getAmbientOcclusionLightValue();
            flag2 = renderer.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_ - 1, p_147808_4_)
                .getCanBlockGrass();
            flag3 = renderer.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_ - 1, p_147808_4_)
                .getCanBlockGrass();
            flag4 = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_ + 1)
                .getCanBlockGrass();
            flag5 = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_ - 1)
                .getCanBlockGrass();
            ...
            if (!flag5 && !flag3) {
                ...
                renderer.aoLightValueScratchXYZNNN = renderer.blockAccess
                    ...
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNNN = p_147808_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_ - 1, p_147808_3_, p_147808_4_ - 1);
            }
            ...
            if (!flag4 && !flag3) {
                ...
                renderer.aoLightValueScratchXYZNNP = renderer.blockAccess
                    .getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_ + 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNNP = p_147808_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_ - 1, p_147808_3_, p_147808_4_ + 1);
            }
            ...
            if (!flag5 && !flag2) {
                ...
                renderer.aoLightValueScratchXYZPNN = renderer.blockAccess
                    .getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_ - 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZPNN = p_147808_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_ + 1, p_147808_3_, p_147808_4_ - 1);
            }
            ...
            if (!flag4 && !flag2) {
                ...
                renderer.aoLightValueScratchXYZPNP = renderer.blockAccess
                    .getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_ + 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZPNP = p_147808_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_ + 1, p_147808_3_, p_147808_4_ + 1);
            }
            ...
            if (renderer.renderMinY <= 0.0D || !renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_)
                .isOpaqueCube()) {
                i1 = p_147808_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_, p_147808_3_ - 1, p_147808_4_);
            }

            f7 = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_)
                .getAmbientOcclusionLightValue();
            f3 = (renderer.aoLightValueScratchXYZNNP + renderer.aoLightValueScratchXYNN
                + renderer.aoLightValueScratchYZNP
                + f7) / 4.0F;
            ...
            renderFaceYNeg(
                ...
                (double) p_147808_3_,
                (double) p_147808_4_,
                renderer.getBlockIcon(p_147808_1_, renderer.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_, 0));
            flag = true;
        }

        if (renderer.renderAllFaces
            || p_147808_1_.shouldSideBeRendered(renderer.blockAccess, p_147808_2_, p_147808_3_ + 1, p_147808_4_, 1)) {
            if (renderer.renderMaxY >= 1.0D) {
                ++p_147808_3_;
            }

            renderer.aoBrightnessXYNP = p_147808_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_ - 1, p_147808_3_, p_147808_4_);
            renderer.aoBrightnessXYPP = p_147808_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_ + 1, p_147808_3_, p_147808_4_);
            renderer.aoBrightnessYZPN = p_147808_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_ - 1);
            renderer.aoBrightnessYZPP = p_147808_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_ + 1);
            renderer.aoLightValueScratchXYNP = renderer.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXYPP = renderer.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZPN = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_ - 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZPP = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_ + 1)
                .getAmbientOcclusionLightValue();
            flag2 = renderer.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_ + 1, p_147808_4_)
                .getCanBlockGrass();
            flag3 = renderer.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_ + 1, p_147808_4_)
            ...
            if (!flag5 && !flag3) {
                ...
                renderer.aoLightValueScratchXYZNPN = renderer.blockAccess
                    .getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_ - 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNPN = p_147808_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_ - 1, p_147808_3_, p_147808_4_ - 1);
            }
            ...
            if (!flag5 && !flag2) {
                ...
                renderer.aoLightValueScratchXYZPPN = renderer.blockAccess
                    .getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_ - 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZPPN = p_147808_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_ + 1, p_147808_3_, p_147808_4_ - 1);
            }
            ...
            if (!flag4 && !flag3) {
                ...
                renderer.aoLightValueScratchXYZNPP = renderer.blockAccess
                    .getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_ + 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNPP = p_147808_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_ - 1, p_147808_3_, p_147808_4_ + 1);
            }
            ...
            if (!flag4 && !flag2) {
                ...
                renderer.aoLightValueScratchXYZPPP = renderer.blockAccess
                    .getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_ + 1)
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZPPP = p_147808_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_ + 1, p_147808_3_, p_147808_4_ + 1);
            }
            ...
            if (renderer.renderMaxY >= 1.0D || !renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_)
                .isOpaqueCube()) {
                i1 = p_147808_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_, p_147808_3_ + 1, p_147808_4_);
            }
            ...
            renderFaceYPos(
                ...
                (double) p_147808_3_,
                (double) p_147808_4_,
                renderer.getBlockIcon(p_147808_1_, renderer.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_, 1));
            flag = true;
        }
        ...
        if (renderer.renderAllFaces
            || p_147808_1_.shouldSideBeRendered(renderer.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_ - 1, 2)) {
            if (renderer.renderMinZ <= 0.0D) {
                --p_147808_4_;
            }

            renderer.aoLightValueScratchXZNN = renderer.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZNN = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZPN = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXZPN = renderer.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoBrightnessXZNN = p_147808_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_ - 1, p_147808_3_, p_147808_4_);
            renderer.aoBrightnessYZNN = p_147808_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_, p_147808_3_ - 1, p_147808_4_);
            renderer.aoBrightnessYZPN = p_147808_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_, p_147808_3_ + 1, p_147808_4_);
            renderer.aoBrightnessXZPN = p_147808_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_ + 1, p_147808_3_, p_147808_4_);
            flag2 = renderer.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_ - 1)
                .getCanBlockGrass();
            flag3 = renderer.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_ - 1)
                .getCanBlockGrass();
            flag4 = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_ - 1)
                .getCanBlockGrass();
            flag5 = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_ - 1)
            ...
            if (!flag3 && !flag5) {
                ...
                renderer.aoLightValueScratchXYZNNN = renderer.blockAccess
                    ...
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNNN = p_147808_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_ - 1, p_147808_3_ - 1, p_147808_4_);
            }
            ...
            if (renderer.renderMinZ <= 0.0D || !renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_ - 1)
                .isOpaqueCube()) {
                i1 = p_147808_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_ - 1);
            }

            f7 = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_ - 1)
                .getAmbientOcclusionLightValue();
        ...
        if (renderer.renderAllFaces
            || p_147808_1_.shouldSideBeRendered(renderer.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_ + 1, 3)) {
            if (renderer.renderMaxZ >= 1.0D) {
                ++p_147808_4_;
            }

            renderer.aoLightValueScratchXZNP = renderer.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXZPP = renderer.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZNP = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchYZPP = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoBrightnessXZNP = p_147808_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_ - 1, p_147808_3_, p_147808_4_);
            renderer.aoBrightnessXZPP = p_147808_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_ + 1, p_147808_3_, p_147808_4_);
            renderer.aoBrightnessYZNP = p_147808_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_, p_147808_3_ - 1, p_147808_4_);
            renderer.aoBrightnessYZPP = p_147808_1_
            ...
            if (renderer.renderMaxZ >= 1.0D || !renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_ + 1)
                .isOpaqueCube()) {
                i1 = p_147808_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_ + 1);
            }
        ...
        if (renderer.renderAllFaces
            || p_147808_1_.shouldSideBeRendered(renderer.blockAccess, p_147808_2_ - 1, p_147808_3_, p_147808_4_, 4)) {
            if (renderer.renderMinX <= 0.0D) {
                --p_147808_2_;
            }

            renderer.aoLightValueScratchXYNN = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXZNN = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_ - 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXZNP = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_ + 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXYNP = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoBrightnessXYNN = p_147808_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_, p_147808_3_ - 1, p_147808_4_);
            renderer.aoBrightnessXZNN = p_147808_1_
            ...
            flag3 = renderer.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_ - 1, p_147808_4_)
                .getCanBlockGrass();
            flag4 = renderer.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_ - 1)
                .getCanBlockGrass();
            flag5 = renderer.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_ + 1)
                .getCanBlockGrass();
            ...
            if (!flag4 && !flag3) {
                ...
                renderer.aoLightValueScratchXYZNNN = renderer.blockAccess
                    ...
                    .getAmbientOcclusionLightValue();
                renderer.aoBrightnessXYZNNN = p_147808_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_, p_147808_3_ - 1, p_147808_4_ - 1);
            }
            ...
            if (renderer.renderMinX <= 0.0D || !renderer.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_)
                .isOpaqueCube()) {
                i1 = p_147808_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_ - 1, p_147808_3_, p_147808_4_);
            }

            f7 = renderer.blockAccess.getBlock(p_147808_2_ - 1, p_147808_3_, p_147808_4_)
                .getAmbientOcclusionLightValue();
        ...
        if (renderer.renderAllFaces
            || p_147808_1_.shouldSideBeRendered(renderer.blockAccess, p_147808_2_ + 1, p_147808_3_, p_147808_4_, 5)) {
            if (renderer.renderMaxX >= 1.0D) {
                ++p_147808_2_;
            }

            renderer.aoLightValueScratchXYPN = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_ - 1, p_147808_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXZPN = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_ - 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXZPP = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_ + 1)
                .getAmbientOcclusionLightValue();
            renderer.aoLightValueScratchXYPP = renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_ + 1, p_147808_4_)
                .getAmbientOcclusionLightValue();
            renderer.aoBrightnessXYPN = p_147808_1_
                .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_, p_147808_3_ - 1, p_147808_4_);
            renderer.aoBrightnessXZPN = p_147808_1_
            ...
            if (renderer.renderMaxX >= 1.0D || !renderer.blockAccess.getBlock(p_147808_2_ + 1, p_147808_3_, p_147808_4_)
                .isOpaqueCube()) {
                i1 = p_147808_1_
                    .getMixedBrightnessForBlock(renderer.blockAccess, p_147808_2_ + 1, p_147808_3_, p_147808_4_);
            }
     ...
     */
    public static boolean renderStandardBlockWithColorMultiplier(RenderBlocks renderer, Block p_147736_1_,
        int p_147736_2_, int p_147736_3_, int p_147736_4_, float p_147736_5_, float p_147736_6_, float p_147736_7_) {
        renderer.enableAO = false;
        Tessellator tessellator = Tessellator.instance;
        boolean flag = false;
        float f3 = 0.5F;
        ...
        if (renderer.renderAllFaces
            || p_147736_1_.shouldSideBeRendered(renderer.blockAccess, p_147736_2_, p_147736_3_ - 1, p_147736_4_, 0)) {
            tessellator.setBrightness(
                renderer.renderMinY > 0.0D ? l
                    : p_147736_1_
                        .getMixedBrightnessForBlock(renderer.blockAccess, p_147736_2_, p_147736_3_ - 1, p_147736_4_));
            ...
            renderFaceYNeg(
                ...
                (double) p_147736_3_,
                (double) p_147736_4_,
                renderer.getBlockIcon(p_147736_1_, renderer.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_, 0));
            flag = true;
        }

        if (renderer.renderAllFaces
            || p_147736_1_.shouldSideBeRendered(renderer.blockAccess, p_147736_2_, p_147736_3_ + 1, p_147736_4_, 1)) {
            tessellator.setBrightness(
            ...
            renderFaceYPos(
                ...
                (double) p_147736_3_,
                (double) p_147736_4_,
                renderer.getBlockIcon(p_147736_1_, renderer.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_, 1));
            flag = true;
        }
        ...
        if (renderer.renderAllFaces
            || p_147736_1_.shouldSideBeRendered(renderer.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_ - 1, 2)) {
            tessellator.setBrightness(
                renderer.renderMinZ > 0.0D ? l
                    : p_147736_1_
                        .getMixedBrightnessForBlock(renderer.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_ - 1));
        ...
        if (renderer.renderAllFaces
            || p_147736_1_.shouldSideBeRendered(renderer.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_ + 1, 3)) {
            tessellator.setBrightness(
        ...
        if (renderer.renderAllFaces
            || p_147736_1_.shouldSideBeRendered(renderer.blockAccess, p_147736_2_ - 1, p_147736_3_, p_147736_4_, 4)) {
            tessellator.setBrightness(
                renderer.renderMinX > 0.0D ? l
                    : p_147736_1_
                        .getMixedBrightnessForBlock(renderer.blockAccess, p_147736_2_ - 1, p_147736_3_, p_147736_4_));
        ...
        if (renderer.renderAllFaces
            || p_147736_1_.shouldSideBeRendered(renderer.blockAccess, p_147736_2_ + 1, p_147736_3_, p_147736_4_, 5)) {
            tessellator.setBrightness(
    ...
    public static void renderFaceYNeg(RenderBlocks renderer, Block block, double x, double y, double z, IIcon icon) {
        ...
        double bottomRightU = maxU;
        double topLeftU = minU;
        double bottomRightV = minV;
        double topLeftV = maxV;
        ...
        double leftX = x + renderer.renderMinX;
        double rightX = x + renderer.renderMaxX;
        double renderY = y + renderer.renderMinY;
        double bottomZ = z + renderer.renderMinZ;
        double topZ = z + renderer.renderMaxZ;

        if (renderer.renderFromInside) {
            leftX = x + renderer.renderMaxX;
            rightX = x + renderer.renderMinX;
        }
        ...
        if (renderer.enableAO) {
            ...
            tessellator.addVertexWithUV(leftX, renderY, topZ, topLeftU, topLeftV);
            ...
            tessellator.addVertexWithUV(leftX, renderY, bottomZ, minU, minV);
            tessellator.setColorOpaque_F(
            ...
            tessellator.addVertexWithUV(rightX, renderY, bottomZ, bottomRightU, bottomRightV);
            tessellator
            ...
            tessellator.addVertexWithUV(rightX, renderY, topZ, maxU, maxV);
        } else {
            tessellator.addVertexWithUV(leftX, renderY, topZ, topLeftU, topLeftV);
            tessellator.addVertexWithUV(leftX, renderY, bottomZ, minU, minV);
            tessellator.addVertexWithUV(rightX, renderY, bottomZ, bottomRightU, bottomRightV);
    ...
    public static void renderFaceYPos(RenderBlocks renderer, Block block, double x, double y, double z, IIcon icon) {
        ...
        double bottomLeftU = maxU;
        double topRightU = minU;
        double bottomLeftV = minV;
        double topRightV = maxV;
        ...
        double rightX = x + renderer.renderMinX;
        double leftX = x + renderer.renderMaxX;
        double renderY = y + renderer.renderMaxY;
        double bottomZ = z + renderer.renderMinZ;
        double topZ = z + renderer.renderMaxZ;

        if (renderer.renderFromInside) {
            rightX = x + renderer.renderMaxX;
            leftX = x + renderer.renderMinX;
        }
        ...
        if (renderer.enableAO) {
            tessellator
                .setColorOpaque_F(renderer.colorRedTopLeft, renderer.colorGreenTopLeft, renderer.colorBlueTopLeft);
            tessellator.setBrightness(renderer.brightnessTopLeft);
            tessellator.addVertexWithUV(leftX, renderY, topZ, maxU, maxV);
            tessellator.setColorOpaque_F(
                renderer.colorRedBottomLeft,
                renderer.colorGreenBottomLeft,
                renderer.colorBlueBottomLeft);
            tessellator.setBrightness(renderer.brightnessBottomLeft);
            tessellator.addVertexWithUV(leftX, renderY, bottomZ, bottomLeftU, bottomLeftV);
            tessellator.setColorOpaque_F(
                renderer.colorRedBottomRight,
                renderer.colorGreenBottomRight,
                renderer.colorBlueBottomRight);
            tessellator.setBrightness(renderer.brightnessBottomRight);
            tessellator.addVertexWithUV(rightX, renderY, bottomZ, minU, minV);
            tessellator
                .setColorOpaque_F(renderer.colorRedTopRight, renderer.colorGreenTopRight, renderer.colorBlueTopRight);
            tessellator.setBrightness(renderer.brightnessTopRight);
            tessellator.addVertexWithUV(rightX, renderY, topZ, topRightU, topRightV);
        } else {
            tessellator.addVertexWithUV(leftX, renderY, topZ, maxU, maxV);
            tessellator.addVertexWithUV(leftX, renderY, bottomZ, bottomLeftU, bottomLeftV);
            tessellator.addVertexWithUV(rightX, renderY, bottomZ, minU, minV);
    ...
    public static void renderFaceZNeg(RenderBlocks renderer, Block block, double x, double y, double z, IIcon icon) {
        ...
        double topX = x + renderer.renderMinX;
        double bottomX = x + renderer.renderMaxX;
        double rightY = y + renderer.renderMinY;
        double leftY = y + renderer.renderMaxY;
        double renderZ = z + renderer.renderMinZ;

        if (renderer.renderFromInside) {
            topX = x + renderer.renderMaxX;
            bottomX = x + renderer.renderMinX;
        }
        ...
        if (renderer.enableAO) {
            tessellator
                .setColorOpaque_F(renderer.colorRedTopLeft, renderer.colorGreenTopLeft, renderer.colorBlueTopLeft);
            tessellator.setBrightness(renderer.brightnessTopLeft);
            tessellator.addVertexWithUV(topX, leftY, renderZ, topLeftU, topLeftV);
            tessellator.setColorOpaque_F(
                renderer.colorRedBottomLeft,
                renderer.colorGreenBottomLeft,
                renderer.colorBlueBottomLeft);
            tessellator.setBrightness(renderer.brightnessBottomLeft);
            tessellator.addVertexWithUV(bottomX, leftY, renderZ, minU, maxV);
            tessellator.setColorOpaque_F(
                renderer.colorRedBottomRight,
                renderer.colorGreenBottomRight,
                renderer.colorBlueBottomRight);
            tessellator.setBrightness(renderer.brightnessBottomRight);
            tessellator.addVertexWithUV(bottomX, rightY, renderZ, bottomRightU, bottomRightV);
            tessellator
                .setColorOpaque_F(renderer.colorRedTopRight, renderer.colorGreenTopRight, renderer.colorBlueTopRight);
            tessellator.setBrightness(renderer.brightnessTopRight);
            tessellator.addVertexWithUV(topX, rightY, renderZ, maxU, minV);
        } else {
            tessellator.addVertexWithUV(topX, leftY, renderZ, topLeftU, topLeftV);
            tessellator.addVertexWithUV(bottomX, leftY, renderZ, minU, maxV);
            tessellator.addVertexWithUV(bottomX, rightY, renderZ, bottomRightU, bottomRightV);
    ...
    public static void renderFaceZPos(RenderBlocks renderer, Block block, double x, double y, double z, IIcon icon) {
        ...
        double leftX = x + renderer.renderMinX;
        double rightX = x + renderer.renderMaxX;
        double bottomY = y + renderer.renderMinY;
        double topY = y + renderer.renderMaxY;
        double renderZ = z + renderer.renderMaxZ;
        ...
        if (renderer.enableAO) {
            tessellator
                .setColorOpaque_F(renderer.colorRedTopLeft, renderer.colorGreenTopLeft, renderer.colorBlueTopLeft);
            tessellator.setBrightness(renderer.brightnessTopLeft);
            tessellator.addVertexWithUV(leftX, topY, renderZ, minU, maxV);
            tessellator.setColorOpaque_F(
                renderer.colorRedBottomLeft,
                renderer.colorGreenBottomLeft,
                renderer.colorBlueBottomLeft);
            tessellator.setBrightness(renderer.brightnessBottomLeft);
            tessellator.addVertexWithUV(leftX, bottomY, renderZ, bottomLeftU, bottomLeftV);
            tessellator.setColorOpaque_F(
                renderer.colorRedBottomRight,
                renderer.colorGreenBottomRight,
                renderer.colorBlueBottomRight);
            tessellator.setBrightness(renderer.brightnessBottomRight);
            tessellator.addVertexWithUV(rightX, bottomY, renderZ, maxU, minV);
            tessellator
                .setColorOpaque_F(renderer.colorRedTopRight, renderer.colorGreenTopRight, renderer.colorBlueTopRight);
            tessellator.setBrightness(renderer.brightnessTopRight);
            tessellator.addVertexWithUV(rightX, topY, renderZ, topRightU, topRightV);
        } else {
            tessellator.addVertexWithUV(leftX, topY, renderZ, minU, maxV);
            tessellator.addVertexWithUV(leftX, bottomY, renderZ, bottomLeftU, bottomLeftV);
            tessellator.addVertexWithUV(rightX, bottomY, renderZ, maxU, minV);
    ...
    public static void renderFaceXNeg(RenderBlocks renderer, Block block, double x, double y, double z, IIcon icon) {
        ...
        double renderX = x + renderer.renderMinX;
        double rightY = y + renderer.renderMinY;
        double leftY = y + renderer.renderMaxY;
        double bottomZ = z + renderer.renderMinZ;
        double topZ = z + renderer.renderMaxZ;
        ...
        if (renderer.renderFromInside) {
            bottomZ = z + renderer.renderMaxZ;
            topZ = z + renderer.renderMinZ;
        }
        ...
        if (renderer.enableAO) {
            tessellator
                .setColorOpaque_F(renderer.colorRedTopLeft, renderer.colorGreenTopLeft, renderer.colorBlueTopLeft);
            tessellator.setBrightness(renderer.brightnessTopLeft);
            tessellator.addVertexWithUV(renderX, leftY, topZ, topLeftU, topLeftV);
            tessellator.setColorOpaque_F(
                renderer.colorRedBottomLeft,
                renderer.colorGreenBottomLeft,
                renderer.colorBlueBottomLeft);
            tessellator.setBrightness(renderer.brightnessBottomLeft);
            tessellator.addVertexWithUV(renderX, leftY, bottomZ, minU, maxV);
            tessellator.setColorOpaque_F(
                renderer.colorRedBottomRight,
                renderer.colorGreenBottomRight,
                renderer.colorBlueBottomRight);
            tessellator.setBrightness(renderer.brightnessBottomRight);
            tessellator.addVertexWithUV(renderX, rightY, bottomZ, bottomRightU, bottomRightV);
            tessellator
                .setColorOpaque_F(renderer.colorRedTopRight, renderer.colorGreenTopRight, renderer.colorBlueTopRight);
            tessellator.setBrightness(renderer.brightnessTopRight);
            tessellator.addVertexWithUV(renderX, rightY, topZ, maxU, minV);
        } else {
            tessellator.addVertexWithUV(renderX, leftY, topZ, topLeftU, topLeftV);
            tessellator.addVertexWithUV(renderX, leftY, bottomZ, minU, maxV);
            tessellator.addVertexWithUV(renderX, rightY, bottomZ, bottomRightU, bottomRightV);
    ...
    public static void renderFaceXPos(RenderBlocks renderer, Block block, double x, double y, double z, IIcon icon) {
        ...
        bottomRightU = maxU;
        double topLeftU = minU;
        double bottomRightV = maxV;
        double topLeftV = minV;
        ...
        double renderX = x + renderer.renderMaxX;
        double leftY = y + renderer.renderMinY;
        double rightY = y + renderer.renderMaxY;
        double bottomZ = z + renderer.renderMinZ;
        double topZ = z + renderer.renderMaxZ;
        ...
        if (renderer.enableAO) {
            ...
            tessellator.setColorOpaque_F(
                ...
                renderer.colorBlueBottomLeft);
            tessellator.setBrightness(renderer.brightnessBottomLeft);
            tessellator.addVertexWithUV(renderX, leftY, bottomZ, maxU, minV);
            tessellator.setColorOpaque_F(
                renderer.colorRedBottomRight,
                renderer.colorGreenBottomRight,
                renderer.colorBlueBottomRight);
            ...
            tessellator
                .setColorOpaque_F(renderer.colorRedTopRight, renderer.colorGreenTopRight, renderer.colorBlueTopRight);
            tessellator.setBrightness(renderer.brightnessTopRight);
            tessellator.addVertexWithUV(renderX, rightY, topZ, minU, maxV);
        } else {
            tessellator.addVertexWithUV(renderX, leftY, topZ, topLeftU, topLeftV);
            tessellator.addVertexWithUV(renderX, leftY, bottomZ, maxU, minV);
            tessellator.addVertexWithUV(renderX, rightY, bottomZ, bottomRightU, bottomRightV);
